...
import { buildOutput, epRoot, excludeFiles, pathRewriter, pkgRoot, projRoot } from '../utils'
...
export const generateTypesDefinitions = async () => {
	...
	const diagnostics = project.getPreEmitDiagnostics().filter((diagnostic) => {
		...
		return filePath && typeSafePaths.some((safePath) => filePath.startsWith(safePath))
	})
